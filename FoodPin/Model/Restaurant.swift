...
struct Restaurant: Hashable {
    ...
    init() {
        self.init(name: "", type: "", location: "", phone: "", description: "", image: "", isFavourite: false)
    }
}
